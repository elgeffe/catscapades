...
- A homeowner clothed in continuous skinned surfaces rather than assembled from capsules: one shirt from hem to collar over a real shoulder cap, one sleeve per arm, and trouser legs that close the crotch between themselves, with shaped shoes on real ankles
